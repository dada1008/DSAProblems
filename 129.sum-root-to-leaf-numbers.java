...
class Solution {
    ...
    private static int sumNumbersRecursively(TreeNode root, int pathSum) {
        if (root == null) {
            return 0;
        }
        ...
        return sumNumbersRecursively(root.left, pathSum) + sumNumbersRecursively(root.right, pathSum);
    }
}
// @lc code=end
