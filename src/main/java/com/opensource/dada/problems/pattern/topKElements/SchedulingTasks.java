 ...
 * Rearrange String K Distance Apart. We need to rearrange tasks such that same tasks
 * are ‘K’ distance apart.
 *
 ...
 * If, for any iteration, we are not able to execute k+1 tasks, the CPU has to remain idle
 * for the remaining time in the next iteration.
 */
