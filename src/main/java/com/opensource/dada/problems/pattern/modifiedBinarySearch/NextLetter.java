...
public class NextLetter {
    public static void main(String[] args) {
        System.out.println("Result:"+searchNextLetter(new char[] {'a', 'c', 'f', 'h'}, 'f'));
        System.out.println("Result:"+searchNextLetter(new char[] {'a', 'c', 'f', 'h'}, 'b'));
        System.out.println("Result:"+searchNextLetter(new char[] {'a', 'c', 'f', 'h'}, 'm'));
        System.out.println("Result:"+searchNextLetter(new char[] {'a', 'c', 'f', 'h'}, 'h'));
    }

    static char searchNextLetter(char[] letters, char key) {
