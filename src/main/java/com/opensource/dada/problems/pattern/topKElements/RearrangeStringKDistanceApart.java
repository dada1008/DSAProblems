 ...
 * i.e., they should be at least ‘2’ distance apart (in other words, there should be
 * at least one character between two same characters), while in the current problem,
 * the same characters should be ‘K’ distance apart.
 *
 * Following a similar approach, since we were inserting a character back in the heap
 * in the next iteration, in this problem, we will re-insert the character after ‘K’ iterations.
 * We can keep track of previous characters in a queue to insert them back
