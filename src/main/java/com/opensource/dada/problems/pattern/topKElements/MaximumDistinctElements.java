 ...
 * <p>
 * Solution #
 * This problem follows the Top ‘K’ Numbers pattern, and shares similarities with
 ...
 * Following a greedy approach, in a stepwise fashion, we will remove the least frequent number
 * from the heap (i.e., the top element of the min-heap), and try to make it distinct.
