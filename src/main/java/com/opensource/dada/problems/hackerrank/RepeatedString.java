 ...
 * It should return an integer representing the number of occurrences of a in the prefix of length
 ...
 * 7
 * Explanation 0
 * The first  letters of the infinite string are abaabaabaa. Because there are  a's,
...
public class RepeatedString {
    public static void main(String[] args) {
        System.out.println("Result:"+repeatedString("aba", 10));//7
        System.out.println("Result:"+repeatedString("a", 1000000000000L));//1000000000000
    }
    ...
    static long repeatedString(String s, long n) {
        ...
        long noOfRepeatedStr = n/s.length();
        repeated = noOfRepeatedStr * repeated;
